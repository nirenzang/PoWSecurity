...
while(highRou - lowRou > epsilon/8)
    ...
    for i=1:numOfStates
        ...
        if a == maxForkLen
            ...
            RsOut{adopt}(i, st2stnum(1, 0, aLose)) = mid1;
            RsOut{adopt}(i, st2stnum(0, 1, aLose)) = mid1;
            RhOut{adopt}(i, st2stnum(1, 0, aLose)) = 0;
            RhOut{adopt}(i, st2stnum(0, 1, aLose)) = 0;
        elseif h == maxForkLen
            ...
            RsOut{adopt}(i, st2stnum(1, 0, aLose)) = mid3;
            RsOut{adopt}(i, st2stnum(0, 1, aLose)) = mid3;
            RhOut{adopt}(i, st2stnum(1, 0, aLose)) = 0;
            RhOut{adopt}(i, st2stnum(0, 1, aLose)) = 0;
        end
    end
