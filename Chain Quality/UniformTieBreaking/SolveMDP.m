...
global POut RsOut RhOut Wrou lowerBoundReward upperBoundReward;
...
while(highRou - lowRou > epsilon/8)
    ...
    for i=1:numOfStates
        ...
        if a == maxForkLen
            ...
            RsOut{adopt}(i, st2stnum(1, 0, inactive)) = mid1;
            RsOut{adopt}(i, st2stnum(0, 1, inactive)) = mid1;
            RhOut{adopt}(i, st2stnum(1, 0, inactive)) = 0;
            RhOut{adopt}(i, st2stnum(0, 1, inactive)) = 0;
        elseif h == maxForkLen
            ...
            RsOut{adopt}(i, st2stnum(1, 0, inactive)) = mid3;
            RsOut{adopt}(i, st2stnum(0, 1, inactive)) = mid3;
            RhOut{adopt}(i, st2stnum(1, 0, inactive)) = 0;
            RhOut{adopt}(i, st2stnum(0, 1, inactive)) = 0;
        end
    end
